...
class AgentManifestPayload
{
  ...
  {
    $commands = $this->registry->manifest();
    ...
    return [
      ...
      'knowledge' => [
        'version' => AgentSystemKnowledge::VERSION,
        'endpoint' => url('/api/agent/context/knowledge'),
        'description' => 'Base de conhecimento operacional — fluxos, documentos, regras de horímetro, manutenção em campo, pro-rata.',
      ],
      ...
      'context_endpoints' => [
        ...
        'knowledge' => url('/api/agent/context/knowledge'),
        'pricing' => url('/api/agent/context/pricing/{id_or_nome}'),
        'part' => url('/api/agent/context/part/{id_or_codigo}'),
      ],
      'document_exports' => [
        ...
        'types' => [
          ...
          ['type' => 'rental_statement', 'label' => 'Demonstrativo por período', 'requires' => ['rental_id|rental_codigo', 'periodo_de', 'periodo_ate']],
