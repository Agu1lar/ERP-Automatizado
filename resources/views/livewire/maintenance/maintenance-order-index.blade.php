...
<div>
            ...
            <div class="flex flex-wrap justify-between items-center gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @can('create', App\Models\Domain\Maintenance\MaintenanceOrder::class)
                        ...
                        <x-btn-primary wire:click="openForm" class="inline-flex items-center">
                            + Nova OS
                            <x-help-hint text="Abre o cadastro da ordem de serviço. Informe o código do patrimônio, descreva o problema e salve. O patrimônio passará para manutenção se a OS for impeditiva." class="ml-2" />
                        </x-btn-primary>
    ...
    @include('livewire.maintenance.partials.new-order-modal')
</div>
